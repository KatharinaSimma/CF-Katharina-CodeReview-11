        ...
        <div class="container w-90 mb-4">
            ...
            <div class="form-group row">
                <div class="form-group col-md-6">
                    <label>Name</label>
                    <input type="text" class="form-control" name="animal_name" placeholder="Name">
                    
                </div>
                <div class="form-group col-md-6">
                    <label>Type</label>
                    <input type="text" class="form-control" name="type" placeholder="Is it a crocodile?">
                </div>
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <textarea name="description" class="form-control" aria-label="With textarea" placeholder="What's the story here?"></textarea>
            </div>
            ...
            <button type="submit" name="submit" class="btn btn-info">Save Animal</button>
